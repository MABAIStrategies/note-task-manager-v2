/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/src/worker-configuration.d.ts --config worker/wrangler.jsonc` (hash: 3890f15313350a49dd45ead72d4c962f)
